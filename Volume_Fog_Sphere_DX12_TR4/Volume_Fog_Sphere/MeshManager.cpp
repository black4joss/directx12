...
void CMeshManager::LoadTextures()
{
	...
	for (UINT j = 0; j < Filename.size(); j++)
	{
		...
		//открываем BMP файл дл€ чтени€ в бинарном режиме
		FILE* Fp = NULL;
		...
		//сдвигаемс€ от начала BMP файла до начала данных
		...
		//читаем из файла rgb данные изображени€
